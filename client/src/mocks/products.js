  ...
  data: [
    {
      ...
      size: "500 ml",
      description:
        "refrescante coca cola para acompañar a tus comidas favoritas.",
    ...
    },
    {
      ...
      size: "6 unid",
      description:
        "empanadas árabes jugosas echa con carne molida de bife especial combinada con  una justa cantidad de jugo de limón, cebolla y tomate.",
    ...
    },
    {
      ...
      size: "600 gr",
      description:
        "deliciosa hamburguesa con doble ración de carne de ternera,  bacon y queso queddar.",
    ...
    },
    {
      ...
      size: "500 gr",
      description:
        "nuggets de pollo xl con rebozado de crujiente y con relleno de queso muzzarella.",
    ...
    },
    {
      ...
      size: "350 gr",
      description:
        "hot dog con salsa chili casera, queso cheddar , lluvia de papas con trazos de cebolla caramelizada.",
